...
const store = {
  menu: [
    { id: 1, name: 'ساج برايم',   desc: 'ستيك مشوي بصلصة الريف الأصيلة',  price: 8500, category: 'm',  emoji: '🥩', hot: true },
    { id: 2, name: 'ساج دجاج',    desc: 'دجاج مشوي مع خضار طازجة',          price: 6500, category: 'm',  emoji: '🍗' },
  ...
  orders: [
    { id: '#212', table: 'T8',  items: 'ساج برايم (1)، بطاطا (2)',   time: '14:35', status: 'new'   },
    { id: '#213', table: 'T5',  items: 'بيتزا (1)، سلطة (1)',         time: '14:38', status: 'new'   },
    { id: '#214', table: 'T6',  items: 'ساج دجاج (2)',                time: '14:42', status: 'ready' },
  ...
  queue: [
    { id: '#201', table: 'T8', items: 'ساج (1)، بطاطا (2)', waiter: 'أحمد',  status: 'serving'  },
