...
interface Rating { table_ref: string; food: number; service: number; overall: number; comment: string; created_at: string }
...
export default function RatingsView() {
  ...
  useEffect(() => {
    api.getRatings().then(data => { setRatings(data as Rating[]); setLoading(false) })
  }, [])
